...
using IndyPOS.CashFlow.Application.Common.Extensions;
using IndyPOS.CashFlow.Application.Common.Interfaces;
using IndyPOS.CashFlow.Application.InvoicePayments;
using IndyPOS.CashFlow.Application.InvoicePayments.Queries.GetInvoicePaymentsByDateRange;
using IndyPOS.CashFlow.Application.InvoicePayments.Queries.GetInvoicePaymentsByInvoiceId;
using IndyPOS.CashFlow.Application.InvoiceProducts;
using IndyPOS.CashFlow.Application.InvoiceProducts.Queries.GetInvoiceProductsByDate;
using IndyPOS.CashFlow.Application.InvoiceProducts.Queries.GetInvoiceProductsByDateRange;
using IndyPOS.CashFlow.Application.InvoiceProducts.Queries.GetInvoiceProductsByInvoiceId;
using IndyPOS.CashFlow.Application.Invoices;
using IndyPOS.CashFlow.Application.Invoices.Queries.GetInvoicesByDateRange;
using IndyPOS.CashFlow.Application.PayLaterPayments;
using IndyPOS.CashFlow.Application.PayLaterPayments.Queries.GetPayLaterPayments;
using IndyPOS.CashFlow.Application.PayLaterPayments.Queries.GetPayLaterPaymentsByDateRange;
using MediatR;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.Logging;
using Prism.Events;

namespace IndyPOS.CashFlow.Infrastructure.Services;
